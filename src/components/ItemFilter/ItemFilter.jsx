...
import { accessoriesSizes, clothingSizes, seasons, shoeSizes } from '../ItemForm/itemFormData'
...
const ItemFilter = ({ data: propsData, category, url }) => {
  ...
  let data = url === 'koko_komero' ? propsData : propsData.filter(item => item.kategoria === category)
  ...
  const sizeOptionList = (category) => {
    if(category === 'Koko Komero') {
      return sizeListsUnique
    } else if(category === 'Asusteet') {
      return accessoriesSizes
    } else if(category === 'Kengät' || category === 'Kausivälineet') {
      return shoeSizes
    } else {
              ...
              <div className='items__filter-wrapper'>
                  ...
                  <div className='items__filter-bar'>
                      <select
                          ...
                          {(sizeOptionList(category)).map(item =>
